  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <div className="mx-auto max-w-5xl p-6">
        ...
        <div className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="mt-10">
            ...
            <input
              ...
              className={`mt-4 w-full ${estimateWeight ? "opacity-50" : ""}`}
            />
        ...
        <div className="mt-10 rounded-3xl border border-slate-200 bg-white p-5 text-sm text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
...
function SummaryCard({
  ...
  return (
    <div className="rounded-3xl bg-white px-6 py-6 shadow-sm dark:bg-slate-900">
...
function CalcRow({
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white px-6 py-7 shadow-sm dark:border-slate-800 dark:bg-slate-900">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-10">
        ...
        <div className="shrink-0 sm:text-right">
          <p className="text-3xl font-bold text-slate-900 dark:text-slate-100 sm:text-4xl">
            {value}
          </p>
        </div>
      </div>
